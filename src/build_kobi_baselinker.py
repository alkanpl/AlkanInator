...
def main() -> None:
    ...
    parser.add_argument(
        "--input",
        default="archived_input_files/input_2026-08-05/Kobi_27_05_2026.xlsx",
        help="Plik XLSX z lista produktow.",
    )
    parser.add_argument(
        "--xml",
        default="archived_input_files/input_2026-08-05/ceneo_kobi.xml",
        help="XML Ceneo/Kobi z atrybutami.",
    )
